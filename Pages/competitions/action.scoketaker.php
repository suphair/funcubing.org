...
<table width="100%">
    <tr>
        <td width="10%" valign='top'>
            ...
            <p><?= ($event->time_limit) ? ('<i class="fas fa-stop-circle"></i> ' . t('Time limit', 'Лимит по времени') . ' ' . $event->time_limit ) : '' ?></p>
            <p><?= ($event->time_limit_cumulative) ? ('<i class="fas fa-plus-circle"></i> ' . t('Time limit', 'Лимит по времени') . ' ' . $event->time_limit_cumulative . ' ' . t('cumulative', 'суммарно') ) : '' ?></p>
            <p><b>DNF</b>: f, F, /, -, d, D.</p>
            <p><b>DNS</b>: s, S, *.</p>
        </td>
