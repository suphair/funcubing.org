...
<form method="POST" action="?rankings_settings">
    ...
    <table class="table_info">
        ...
        <?php } else { ?>
            <?php foreach ($comp_data->delegates as $comp_delegate) { ?>
                <tr>
                    <td>Делегат / Роль</td>
                    <td>
                        <?php
                        foreach ($delegates as $delegate) {
                            if ($comp_delegate->wcaid == $delegate->wcaid) {
                                ?>
                                <?= $delegate->name ?> - <?= $delegate->rank ?>
                            <?php } ?>
                        <?php } ?>/
                        <?= $comp_delegate->role ?>
                    </td>
        ...
        <tr>
            ...
            <td>
                <input name="approved" type="checkbox" <?= $comp->approved ? 'checked' : '' ?>>
            </td>
        </tr>
        <tr>
            <td>
